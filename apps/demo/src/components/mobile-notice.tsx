...
export function MobileNotice() {
  return (
    <div className="fixed inset-x-0 top-0 z-[60] flex items-center justify-between gap-3 border-b border-border bg-muted px-3 py-1.5 text-xs text-muted-foreground sm:hidden">
