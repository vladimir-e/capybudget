...
- **Duplicates** are unselected with a banner splitting certain matches from possible (close-date) ones, which carry an amber badge prompting review; low-confidence and uncategorized rows are flagged once the run settles.
